    ...
    def create_mesh_object(
        ...
        for element in elements:
            ...
            if element.SemanticName == "POSITION":
                ...
                pass
            elif element.SemanticName.startswith("UNKNOWN"):
                # LoyalTools: EFMI 提取的布局可能包含 UNKNOWN 占位元素 (输入布局中的字节空隙填充)，
                # 这些元素没有可导入的语义，跳过即可，不影响其它元素解析。
                print("跳过 UNKNOWN 占位元素: " + element.ElementName)
            else:
